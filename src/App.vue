...
import { clearCurrentNodeId, clearParentDirectoryId } from '@/utils/directory'
 ...
 */
onMounted(async () => {
  // ✅ 页面刷新时清除 currentNodeId 和 parentDirectoryId（会话级变量）
  clearCurrentNodeId()
  clearParentDirectoryId()
  logger.info('已清除 currentNodeId 和 parentDirectoryId')
